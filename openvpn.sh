...
create_server_config() {
	# Create log directory for status file
	mkdir -p /var/log/openvpn
	chown nobody:"$group_name" /var/log/openvpn
...
finish_setup() {
	...
	echo
	echo "Bandwidth tracking is enabled. View statistics with:"
